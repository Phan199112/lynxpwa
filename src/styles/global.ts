...
const orangeColor = '#FF9800'; // #FFC840
const orangeColorRGB = '255, 152, 0';
const orangeColorLight = '#ffa726';
const orangeColorDark = '#fb8c00';
const yellowColor = '#F7FF4D';
const grayColor = '#999999';
const blackColor = '#1B1B1B';

const primaryBoxShadow = {
  boxShadow: `0 12px 20px -10px rgba(156, 39, 176, 0.28),
    0 4px 20px 0px rgba(0, 0, 0, 0.12),
    0 7px 8px -5px rgba(156, 39, 176, 0.2)`,
};
const infoBoxShadow = {
  boxShadow: `0 12px 20px -10px rgba(0, 188, 212, 0.28),
    0 4px 20px 0px rgba(0, 0, 0, 0.12),
...
const orangeBoxShadow = {
  boxShadow: `0 12px 20px -10px rgba(${orangeColorRGB}, 0.28),
    0 4px 20px 0px rgba(0, 0, 0, 0.12),
    0 7px 8px -5px rgba(${orangeColorRGB}, 0.2)`,
};
...
const orangeCardHeader = {
  background: `linear-gradient(60deg, ${orangeColorLight}, ${orangeColorDark})`,
  ...orangeBoxShadow,
};
...
export type ColorsType = 'primary' | 'warning' | 'danger' | 'success' | 'info' | 'rose' | 'gray';
