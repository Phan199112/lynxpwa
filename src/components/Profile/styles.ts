...
type StyleKeysType = 'wizardContainer'
  | 'card'
  | 'wizardHeader'
  | 'title'
  | 'subtitle'
  ...
  | 'stepContent'
  | 'movingTab'
  | 'primary' | 'warning' | 'danger' | 'success' | 'info' | 'rose' | 'orange'
  | 'clearfix'
  | 'footer'
  | 'left'
  | 'right';
...
const styles: StyleRules<StyleKeysType> = {
  ...
  orange: {
    ...
    boxShadow: `0 4px 20px 0px rgba(0, 0, 0, 0.14), 0 7px 10px -5px rgba(${orangeColorRGB}, 0.4)`,
  },
  footer: {
    padding: '0 15px',
  },
