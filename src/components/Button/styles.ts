...
const buttonStyle = {
  button: {
    ...
    '&:hover,&:focus': {
      color: '#FFFFFF',
      backgroundColor: grayColor,
      boxShadow: `0 14px 26px -12px rgba(153, 153, 153, 0.42),
  ...
  info: {
    ...
    boxShadow: `0 2px 2px 0 rgba(0, 188, 212, 0.14),
      0 3px 1px -2px rgba(0, 188, 212, 0.2),
      0 1px 5px 0 rgba(0, 188, 212, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: infoColor,
      boxShadow: `0 14px 26px -12px rgba(0, 188, 212, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  success: {
    ...
    '&:hover,&:focus': {
      backgroundColor: successColor,
      boxShadow: `0 14px 26px -12px rgba(76, 175, 80, 0.42),
      0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  warning: {
    ...
    boxShadow: `0 2px 2px 0 rgba(255, 152, 0, 0.14),
      0 3px 1px -2px rgba(255, 152, 0, 0.2),
      0 1px 5px 0 rgba(255, 152, 0, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: warningColor,
      boxShadow: `0 14px 26px -12px rgba(255, 152, 0, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  danger: {
    ...
    '&:hover,&:focus': {
      backgroundColor: dangerColor,
      boxShadow: `0 14px 26px -12px rgba(244, 67, 54, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  rose: {
    ...
    '&:hover,&:focus': {
      backgroundColor: roseColor,
      boxShadow: `0 14px 26px -12px rgba(233, 30, 99, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  orange: {
    ...
    boxShadow: `0 2px 2px 0 rgba(${orangeColorRGB}, 0.14),
      0 3px 1px -2px rgba(${orangeColorRGB}, 0.2),
      0 1px 5px 0 rgba(${orangeColorRGB}, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: orangeColor,
      boxShadow: `0 14px 26px -12px rgba(${orangeColorRGB}, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
        0 8px 10px -5px rgba(${orangeColorRGB}, 0.2)`,
    },
  },
  white: {
    '&,&:focus,&:hover': {
  ...
  twitter: {
    ...
    color: '#fff',
    boxShadow: `0 2px 2px 0 rgba(85, 172, 238, 0.14),
      0 3px 1px -2px rgba(85, 172, 238, 0.2),
      0 1px 5px 0 rgba(85, 172, 238, 0.12)`,
    '&:hover,&:focus,&:visited': {
      backgroundColor: '#55acee',
      color: '#fff',
      boxShadow: `0 14px 26px -12px rgba(85, 172, 238, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  facebook: {
    ...
    color: '#fff',
    boxShadow: `0 2px 2px 0 rgba(59, 89, 152, 0.14),
      0 3px 1px -2px rgba(59, 89, 152, 0.2),
      0 1px 5px 0 rgba(59, 89, 152, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: '#3b5998',
      color: '#fff',
      boxShadow: `0 14px 26px -12px rgba(59, 89, 152, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  google: {
    ...
    color: '#fff',
    boxShadow: `0 2px 2px 0 rgba(221, 75, 57, 0.14),
      0 3px 1px -2px rgba(221, 75, 57, 0.2),
      0 1px 5px 0 rgba(221, 75, 57, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: '#dd4b39',
      color: '#fff',
      boxShadow: `0 14px 26px -12px rgba(221, 75, 57, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  linkedin: {
    ...
    color: '#fff',
    boxShadow: `0 2px 2px 0 rgba(9, 118, 180, 0.14),
      0 3px 1px -2px rgba(9, 118, 180, 0.2),
      0 1px 5px 0 rgba(9, 118, 180, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: '#0976b4',
      color: '#fff',
      boxShadow: `0 14px 26px -12px rgba(9, 118, 180, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  pinterest: {
    ...
    color: '#fff',
    boxShadow: `0 2px 2px 0 rgba(204, 33, 39, 0.14),
      0 3px 1px -2px rgba(204, 33, 39, 0.2),
      0 1px 5px 0 rgba(204, 33, 39, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: '#cc2127',
      color: '#fff',
      boxShadow: `0 14px 26px -12px rgba(204, 33, 39, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  youtube: {
    ...
    color: '#fff',
    boxShadow: `0 2px 2px 0 rgba(229, 45, 39, 0.14),
      0 3px 1px -2px rgba(229, 45, 39, 0.2),
      0 1px 5px 0 rgba(229, 45, 39, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: '#e52d27',
      color: '#fff',
      boxShadow: `0 14px 26px -12px rgba(229, 45, 39, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  tumblr: {
    ...
    color: '#fff',
    boxShadow: `0 2px 2px 0 rgba(53, 70, 92, 0.14),
      0 3px 1px -2px rgba(53, 70, 92, 0.2),
      0 1px 5px 0 rgba(53, 70, 92, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: '#35465c',
      color: '#fff',
      boxShadow: `0 14px 26px -12px rgba(53, 70, 92, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  github: {
    ...
    color: '#fff',
    boxShadow: `0 2px 2px 0 rgba(51, 51, 51, 0.14),
      0 3px 1px -2px rgba(51, 51, 51, 0.2),
      0 1px 5px 0 rgba(51, 51, 51, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: '#333333',
      color: '#fff',
      boxShadow: `0 14px 26px -12px rgba(51, 51, 51, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  behance: {
    ...
    color: '#fff',
    boxShadow: `0 2px 2px 0 rgba(23, 105, 255, 0.14),
      0 3px 1px -2px rgba(23, 105, 255, 0.2),
      0 1px 5px 0 rgba(23, 105, 255, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: '#1769ff',
      color: '#fff',
      boxShadow: `0 14px 26px -12px rgba(23, 105, 255, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  dribbble: {
    ...
    color: '#fff',
    boxShadow: `0 2px 2px 0 rgba(234, 76, 137, 0.14),
      0 3px 1px -2px rgba(234, 76, 137, 0.2),
      0 1px 5px 0 rgba(234, 76, 137, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: '#ea4c89',
      color: '#fff',
      boxShadow: `0 14px 26px -12px rgba(234, 76, 137, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
  ...
  reddit: {
    ...
    color: ' #fff',
    boxShadow: `0 2px 2px 0 rgba(255, 69, 0, 0.14),
      0 3px 1px -2px rgba(255, 69, 0, 0.2),
      0 1px 5px 0 rgba(255, 69, 0, 0.12)`,
    '&:hover,&:focus': {
      backgroundColor: '#ff4500',
      color: ' #fff',
      boxShadow: `0 14px 26px -12px rgba(255, 69, 0, 0.42),
        0 4px 23px 0px rgba(0, 0, 0, 0.12),
...
export default buttonStyle as StyleRules;
